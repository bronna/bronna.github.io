...
////Update caption text
    ...
    changeTopText(newText = "If, by the hour, the ceo-to-worker pay ratio had stayed the same, workers would only need to work...",
...
////Draw rest of data
    ...
    let captionBottom = bounds.append("text")
        ...
        .attr("fill", "white")
        .attr("text-anchor", "middle")
        .text("…per week to get their current pay.")
        .call(wrap, 230)
        .attr("opacity", 0)
